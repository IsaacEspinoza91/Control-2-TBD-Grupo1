...
public class TareaCercanaResponseDTO {
    ...
    public TareaCercanaResponseDTO() {}

    // Constructor para convertir de Tarea a TareaResponseDTO
    public TareaCercanaResponseDTO(TareaWithDistanciaDTO tarea) {
        this.id = tarea.getId();
        ...
        this.distancia = tarea.getDistancia();
